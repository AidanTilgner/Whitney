...
# backend and frontend servers for local development. It ensures all
...
pnpm run dev &> "$PROJECT_ROOT/frontend.log" &
...
echo ""
echo "The application will be available at the URL provided by the frontend server (usually http://localhost:5173)."
